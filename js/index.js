...
$(function () {
	layui.use(['layer'], function () {
		...
		layer.open({
			type: 1,
			area: ['310px', '350px'], //宽高更多源码资源下载<br>
			content: '<div style="text-align: center;"><br><a href="https://www.zxki.cn" target="_blank"><img src="https://www.zxki.cn/content/templates/Cruel/img/logo.png" style="width:80%; margin-bottom:15px;"></a><br>酷库博客<br>公告内容在/js/index.js中修改</div>',
			title: '公告信息',
			btn: ['关闭'],
			btnAlign: 'c',
			shade: 0,
